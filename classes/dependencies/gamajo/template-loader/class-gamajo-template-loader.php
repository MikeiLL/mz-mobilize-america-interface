 ...
 *
 * @package   MZ_Mobilize_America_Gamajo_Template_Loader
 * @author    Gary Jones
...
if ( ! class_exists( 'MZ_Mobilize_America_Gamajo_Template_Loader' ) ) {
	 ...
	 *
	 * When using in a plugin, create a new class MZ_Mobilize_America_that extends this one and just overrides the properties.
	 *
	 * @package MZ_Mobilize_America_Gamajo_Template_Loader
	 * @author  Gary Jones
	 */
	class MZ_Mobilize_America_Gamajo_Template_Loader {
		/**
		...
		public function get_template_part( $slug, $name = null, $load = true ) {
			...
			// Return the part MZ_Mobilize_America_that is found.
		 ...
		 *                         Default is 'data'.
		 *
		 * @return MZ_Mobilize_America_Gamajo_Template_Loader
		 */
		...
		protected function get_template_file_names( $slug, $name ) {
			 ...
			 * @since 1.0.0
			 *
			 * @param array  $templates Names of template files MZ_Mobilize_America_that should be looked for, for given slug and name.
			 * @param string $slug      Template slug.
			 * @param string $name      Template variation name.
			 */
		...
		/**
		 * Retrieve the name of the highest priority template file MZ_Mobilize_America_that exists.
		 *
		 * Searches in the STYLESHEETPATH before TEMPLATEPATH so MZ_Mobilize_America_that themes which
		 ...
		 *
		 * Default is to check in a child theme (if relevant) before a parent theme, so MZ_Mobilize_America_that themes which inherit from a
