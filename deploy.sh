...
CURRENTDIR=$(pwd)
default_svnpath="/tmp/mz-mobilize-america-interface"
default_svnurl="http://plugins.svn.wordpress.org/mz-mobilize-america-interface"
default_svnuser="mikeill"
default_plugindir="$CURRENTDIR"
default_mainfile="mz-mobilize-america.php"
