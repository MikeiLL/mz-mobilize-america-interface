...
# main config
PLUGINSLUG="mobilize-america-interface"
CURRENTDIR=`pwd`
MAINFILE="mobilize-america.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/mobilize-america-interface" # Remote SVN repo on wordpress.org, with no trailing slash
